...
_Example: switch to channel '123':_
...
_Example: Send 'Home', 'Left' and 'Enter':_

`KEY_HOME,KEY_LEFT,KEY_ENTER`

_Example: Set the aspect ratio, increase the volume 10 times, wait 2.5 seconds (2500 ms) and then press play:_
