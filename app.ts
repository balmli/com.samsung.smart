...
class SamsungSmartApp extends Homey.App {
    ...
    async initFlows() {
        this.homey.flow
            .getConditionCard('is_power_onoff')
        ...
        this.homey.flow.getActionCard('browse').registerRunListener(args => {
        ...
        this.homey.flow
            .getActionCard('set_input_source')
