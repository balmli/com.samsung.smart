...
module.exports = class SamsungEncrypted extends SamsungBase {
    ...
    async getApp(appId) {
        return new Promise((resolve, reject) => {
            http.get({
                uri: 'http://' + this._config.ip_address + ':8080/ws/apps/' + appId,
    ...
    async launchApp(appId, launchData) {
        ...
        console.log('launchApp', appId, lData);
        return new Promise((resolve, reject) => {
            http.post({
                uri: 'http://' + this._config.ip_address + ':8080/ws/apps/' + appId,
                headers: {
                ...
                .then(function (data) {
                    console.log('launchApp OK', appId, lData);
                    resolve(true);
                })
                .catch(function (err) {
                    console.log('launchApp ERROR', err);
                    reject(false);
                });
        });
    }
