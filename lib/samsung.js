            ...
            if (this.socket) {
                ...
                this.socket.on('message', data => {
                    ...
                    if (data.event === "ms.channel.connect") {
                        ...
                        data.event === 'ed.edenApp.get' ||
                        data.event === 'ed.apps.launch' ||
                        data.event === 'ms.voiceApp.standby' ||
                        data.event === 'ms.voiceApp.hide' ||
                        data.event === 'ms.remote.imeStart' ||
                        data.event === 'ms.remote.imeUpdate' ||
                        data.event === 'ms.remote.touchEnable') {
                        console.log(`_connection: event: ${data.event}`);
                    } else {
                        console.log(`_connection: unknown event: ${data.event}`);
                    }
